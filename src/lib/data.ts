...
export const projects: Project[] = [
  {
    ...
    longDescription: "A distributed ML inference platform on GKE with sync and Kafka-backed async serving paths, KS-test drift detection, and weighted A/B model rollouts.",
  ...
  },
  {
    ...
    longDescription: "A vector search engine with a hand-written HNSW index, on-disk format, and query layer, running single-node or sharded across a consistent-hash coordinator.",
